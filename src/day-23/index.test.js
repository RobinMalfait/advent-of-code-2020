...
import part1, { splitAtValue } from './part-1.js'
import part2 from './part-2.js'

let data = promises.readFile(resolve(process.cwd(), 'data', '23.txt'), 'utf8')
...
describe('Part 1', () => {
  ...
  ])('should prodice the correct value for example %#', (input, expected, rounds) => {
...
describe('Part 2', () => {
  it.each([['389125467', 934001 * 159792]])('should prodice the correct value for example %#', (input, expected) => {
